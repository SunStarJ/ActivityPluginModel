...
abstract class SSSingleBaseAdapter<T1, T2 : ViewDataBinding>(var mContext: Context) : RecyclerView.Adapter<SSSingleBaseAdapter.SSBaseViewHolder>() {
    ...
    fun initDataList(dataList: MutableList<T1>): SSSingleBaseAdapter<T1, T2> {
        this.dataList = dataList
        return this
    }

    fun initBindView(bindview: BindView<T2>): SSSingleBaseAdapter<T1, T2> {
